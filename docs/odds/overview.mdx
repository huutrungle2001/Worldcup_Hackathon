...
<CardGroup cols={2}>
  ...
  <Card title="Cryptographic Auditing" icon="link">
    On-chain anchored records for trustless verification and historic
    backtesting.
  </Card>
  <Card title="Flexible Performance" icon="gauge">
    60-second batch updates (Build tier) or sub-second real-time streams (Scale
    tier).
  </Card>
</CardGroup>

<Info>
  **Looking for integration specs?** Jump straight to the [Odds API
  Reference](/api-reference/odds) to view schemas for full fixture lifecycles
