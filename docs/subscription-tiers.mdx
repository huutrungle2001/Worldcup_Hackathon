...
<Info>
  **Subscription Duration**: Subscriptions must be purchased in multiples of 4
  weeks (28 days). Minimum term is 4 weeks.
</Info>
...
<Info>
  **Pricing subject to change**: Pricing structure may be updated at any time.
  Active subscriptions will honor the terms agreed upon at the time of purchase.
</Info>
